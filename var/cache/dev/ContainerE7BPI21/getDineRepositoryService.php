 ...
 */
class getDineRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DineRepository' shared autowired service.
     *
     * @return \App\Repository\DineRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DineRepository.php';

        return $container->privates['App\\Repository\\DineRepository'] = new \App\Repository\DineRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
