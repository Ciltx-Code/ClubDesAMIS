 ...
 */
class getCommissionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CommissionRepository' shared autowired service.
     *
     * @return \App\Repository\CommissionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CommissionRepository.php';

        return $container->privates['App\\Repository\\CommissionRepository'] = new \App\Repository\CommissionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
