 ...
 */
class getInscritRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InscritRepository' shared autowired service.
     *
     * @return \App\Repository\InscritRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InscritRepository.php';

        return $container->privates['App\\Repository\\InscritRepository'] = new \App\Repository\InscritRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
