 ...
 */
class getParraineRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ParraineRepository' shared autowired service.
     *
     * @return \App\Repository\ParraineRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ParraineRepository.php';

        return $container->privates['App\\Repository\\ParraineRepository'] = new \App\Repository\ParraineRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
