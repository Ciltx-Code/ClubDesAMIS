 ...
 */
class getDinerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DinerRepository' shared autowired service.
     *
     * @return \App\Repository\DinerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DinerRepository.php';

        return $container->privates['App\\Repository\\DinerRepository'] = new \App\Repository\DinerRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
